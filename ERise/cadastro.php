                ...
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="login.php">
                            <img src="../designer/img/icons/person-fill.svg" alt="" width="15" height="15" title="Logar">
                            Logar
                        </a>
                    </li>
                </ul>
        ...
        <center>
            ...
            <form action="../API/cadastrar.php" method="POST">
                <div class="form-group">
                    ...
                    <input class="formlogin" type="text" placeholder="Nome" name="nome" id="nome" required>
                </div>
                <div class="form-group">
                    <label for="" class="textologin">E-Mail</label><br>
                    <input class="formlogin" type="email" placeholder="E-mail" name="email" id="email" required>
                </div>
                <div class="form-group">
                    <label for="" class="textologin">Senha</label><br>
                    <input class="formlogin" type="password" placeholder="Senha" name="senha" id="senha" required>
                </div>
                <div class="form-group">
                    <label for="" class="textologin">CPF</label><br>
                    <input class="formlogin" type="text" placeholder="CPF" name="cpf" id="cpf" required>
                </div>
                <div class="form-group">
                    <label for="" class="textologin">RG</label><br>
                    <input class="formlogin" type="text" placeholder="RG" name="rg" id="rg" required>
                </div>
                <div class="form-group">
                    <label for="" class="textologin">Data Nascimento</label><br>
                    <input class="formlogin" type="date" placeholder="Data de Nascimento" id="datanas" name="datanasc" required>
                </div>
                <br>
