                ...
                <div class="container-fluid">
                    <center>
                        <form action="#" method="POST">
                            ...
                            <div class="form-group">
                                <label for="" class="textologin">Tamanho:</label><br>
                                <input type="email" class="form-control" style="width: 550px;" placeholder="Tamanho" name="email" id="email" required>
                            </div>
                            <div class="form-group">
                                <label for="" class="textologin">Peso:</label><br>
                                <input type="password" class="form-control" style="width: 550px;" placeholder="Peso" name="senha" id="senha" required>
                            </div>
                            <div class="form-group">
                                <label for="" class="textologin">Preço:</label><br>
                                <input type="text" class="form-control" style="width: 550px;" placeholder="Preço" name="cpf" id="cpf" required>
                            </div>
                            <br>
