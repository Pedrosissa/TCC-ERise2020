<?php
    ...
    $result_usuario = "SELECT * FROM loja WHERE id = '2'";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <center>
                        <form action="../API/admin/editarloja.php" method="POST">
                            <div class="form-group">
                                <label for="" class="textologin">Nome</label><br>
                                <input type="text" class="form-control" style="width: 550px;" placeholder="Nome" name="nome" id="nome">
                            </div>
                            <div class="form-group">
                                <label for="" class="textologin">E-Mail</label><br>
                                <select id="categ" name="categ" required class="form-control" style="width: 550px;"><br>
                            ...
                            <button type="input" class="btn btn-primary btn-sm">Editar</button><br>
                    </center>
